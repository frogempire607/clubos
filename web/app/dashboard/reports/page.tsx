  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-stone-500 mt-1">Analytics and exportable reports for your club</p>
      </div>
      <div className="border border-dashed border-stone-200 rounded-xl py-24 text-center">
        ...
        <p className="text-stone-600 font-medium mb-1">Reports coming soon</p>
