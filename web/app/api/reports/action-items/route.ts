...
import { buildActionItems } from "@/lib/reportsActionItems";

// GET /api/reports/action-items
//
// The list of tasks the owner should act on today, powering the Snapshot's
// "What requires my attention today?" answer.
export async function GET() {
  ...
  const payload = await buildActionItems(clubId, session.user.id);
