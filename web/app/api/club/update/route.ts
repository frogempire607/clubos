...
const schema = z.object({
  ...
  mailingAddress2: z.string().max(200).optional().nullable(),
  mailingCity: z.string().max(100).optional().nullable(),
  mailingState: z.string().max(100).optional().nullable(),
  mailingZip: z.string().max(20).optional().nullable(),
  mailingCountry: z.string().max(100).optional().nullable(),
  ...
  try {
    ...
    const club = await prisma.club.update({
      ...
      data: {
        ...
        ...(data.publicPhone !== undefined ? { publicPhone: data.publicPhone || null } : {}),
        ...(data.mailingAddress !== undefined ? { mailingAddress: data.mailingAddress || null } : {}),
        ...(data.mailingAddress2 !== undefined ? { mailingAddress2: data.mailingAddress2 || null } : {}),
        ...
        ...(data.mailingCountry !== undefined ? { mailingCountry: data.mailingCountry || null } : {}),
