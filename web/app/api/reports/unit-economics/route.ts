...
import { buildUnitEconomics } from "@/lib/reportsUnitEconomics";

// GET /api/reports/unit-economics?range=&from=&to=
export async function GET(req: Request) {
  ...
  const payload = await buildUnitEconomics(clubId, range);
